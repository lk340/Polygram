            ...
            <div className="photo-modal-data">
              ...
              <div className="photo-modal-caption-holder">
                <div className="photo-modal-caption">
                  <div className="photo-modal-caption-caption"><span onClick={this.onModalClose}>{this.props.allUsers[this.props.user_id].username} </span> {this.state.photoCaption}</div>
