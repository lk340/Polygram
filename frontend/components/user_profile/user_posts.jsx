            ...
            <div className="photo-modal-data">
              ...
              <div className="photo-modal-username">
                <div>
                  ...
                  &nbsp; &nbsp; 
                  <span className="photo-modal-username-span" onClick={this.onModalClose}><b>{ this.props.allUsers[this.props.user_id] ? this.props.allUsers[this.props.user_id].username : console.log("") }</b></span>
                </div>
              </div>
              ...
              <div className="photo-modal-caption-holder">
                <div className="photo-modal-caption">
                  <div className="photo-modal-caption-caption"><span onClick={this.onModalClose}>{this.props.allUsers[this.props.user_id] ? this.props.allUsers[this.props.user_id].username : console.log("")} </span> {this.state.photoCaption}</div>
